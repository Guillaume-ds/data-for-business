...
# </div>
# 
# Once we computed the covariance matrix, we can find the **corresponding eingenvectors and eigenvalues**. Remember that $\lambda$ is said to be an **eigenvalue of** $\Sigma$ if:
# 
...
# </center>
# 
# #### Sources and other documentation 
# 
